...
* `2017.12.16.0` Fixed a bug when searching, the Cherish ball was missing from the dropdown menu. The result was an always empty list when searching through my event tab.
